...
require('hader.php');
$query = "SELECT product.*, category.category_name FROM product INNER JOIN category ON product.category_id=4 = category.category_id";
                    ...
                    <div class="product-items product-items-3">
                        ...
                        <div class="product-item" data-catalogid="3" data-ajaxcart="1" data-addcart-callback="addcart_callback" data-categoryid="8">
                            ...
                            <div class="product-content">
                                <div class="name">
                                    <a href="single.php?id=<?php echo $row['prod_id']; ?>"><?php echo $row['prod_name'] ?></a> <br/>
