    ...
    <div class="container">
        <div class="row">
            <div class="content-area col-lg-12">
                <form action="https://veniam-preview-com.3dcartstores.com/giftregistry_home.asp" name="frmForm" id="frmForm" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="create-registry-button col-lg-12">
                            <button type="button" class="btn btn-primary" onclick="window.location='giftregistry_prelogin.html';">Create My Gift Registry</button>
                        </div>
                    </div>
                    <div class="row">
                        <div class="registryInfo col-lg-12">
